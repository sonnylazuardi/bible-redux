module.exports = [
  {name: 'Genesis', name_id: 'Kejadian', total: 50, value: 'Gen', type: 'old'},
  {name: 'Exodus', name_id: 'Keluaran', total: 40, value: 'Exo', type: 'old'},
  {name: 'Leviticus', name_id: 'Imamat', total: 27, value: 'Lev', type: 'old'},
  {name: 'Numbers', name_id: 'Bilangan', total: 36, value: 'Num', type: 'old'},
  {name: 'Deuteronomy', name_id: 'Ulangan', total: 34, value: 'Deu', type: 'old'},
  ...
  {name: '1 Samuel', name_id: '1 Samuel', total: 31, value: '1Sa', type: 'old'},
  {name: '2 Samuel', name_id: '2 Samuel', total: 24, value: '2Sa', type: 'old'},
  {name: '1 Kings', name_id: '1 Raja', total: 22, value: '1Ki', type: 'old'},
  {name: '2 Kings', name_id: '2 Raja', total: 25, value: '2Ki', type: 'old'},
  {name: '1 Chronicles', name_id: '1 Tawarikh', total: 29, value: '1Chr', type: 'old'},
  {name: '2 Chronicles', name_id: '2 Tawarikh', total: 36, value: '2Chr', type: 'old'},
  {name: 'Ezra', name_id: 'Ezra', total: 10, value: 'Ezr', type: 'old'},
  {name: 'Nehemiah', name_id: 'Nehemia', total: 13, value: 'Neh', type: 'old'},
  ...
  {name: 'Ecclesiastes', name_id: 'Pengkotbah', total: 12, value: 'Ecc', type: 'old'},
  {name: 'Song of Solomon', name_id: 'Kidung Agung', total: 8, value: 'Song', type: 'old'},
  {name: 'Isaiah', name_id: 'Yesaya', total: 66, value: 'Isa', type: 'old'},
  {name: 'Jeremiah', name_id: 'Yeremia', total: 52, value: 'Jer', type: 'old'},
  {name: 'Lamentations', name_id: 'Ratapan', total: 5, value: 'Lam', type: 'old'},
  {name: 'Ezekiel', name_id: 'Yehezkiel', total: 48, value: 'Eze', type: 'old'},
  ...
  {name: 'Zephaniah', name_id: 'Zefanya', total: 3, value: 'Zep', type: 'old'},
  {name: 'Haggai', name_id: 'Hagai', total: 2, value: 'Hag', type: 'old'},
  {name: 'Zechariah', name_id: 'Zakharia', total: 14, value: 'Zec', type: 'old'},
  ...
  {name: 'Acts', name_id: 'Kisah Para Rasul', total: 28, value: 'Act', type: 'new'},
  {name: 'Romans', name_id: 'Roma', total: 16, value: 'Rom', type: 'new'},
  {name: '1 Corinthians', name_id: '1 Korintus', total: 16, value: '1Co', type: 'new'},
  {name: '2 Corinthians', name_id: '2 Korintus', total: 13, value: '2Co', type: 'new'},
  {name: 'Galatians', name_id: 'Galatia', total: 6, value: 'Gal', type: 'new'},
  {name: 'Ephesians', name_id: 'Efesus', total: 6, value: 'Eph', type: 'new'},
  {name: 'Philippians', name_id: 'Filipi', total: 4, value: 'Phi', type: 'new'},
  {name: 'Colossians', name_id: 'Kolose', total: 4, value: 'Col', type: 'new'},
  {name: '1 Thessalonians', name_id: '1 Tesalonika', total: 5, value: '1Th', type: 'new'},
  {name: '2 Thessalonians', name_id: '2 Tesalonika', total: 3, value: '2Th', type: 'new'},
  {name: '1 Timothy', name_id: '1 Timotius', total: 6, value: '1Ti', type: 'new'},
  {name: '2 Timothy', name_id: '2 Timotius', total: 4, value: '2Ti', type: 'new'},
